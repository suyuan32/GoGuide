import{_ as n}from"./context-Zv-w9OUj.js";import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as t,b as e}from"./app-1FJRdMf0.js";const o={},c=e(`<h2 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction"><span>Introduction</span></a></h2><p><code>Context</code> is a very important interface in Golang, used to define the context information in <code>goroutine</code>. <code>Context</code> is commonly used in the following situations:</p><ul><li>Data transfer: Transfer data among multiple <code>goroutines</code>.</li><li>Timeout management: By setting a timeout, the termination time of the coroutine can be conveniently configured.</li><li>Terminate coroutine: By using the <code>cancel()</code> method, the coroutine can be easily terminated, and multiple coroutines can be managed in batches.</li></ul><h3 id="context-interface" tabindex="-1"><a class="header-anchor" href="#context-interface"><span>Context Interface</span></a></h3><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// A Context carries a deadline, a cancelation signal, and other values across</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="root-nodes-and-derived-nodes" tabindex="-1"><a class="header-anchor" href="#root-nodes-and-derived-nodes"><span>Root Nodes and Derived Nodes</span></a></h2><p>We can create root nodes and derived nodes for <code>context</code>, forming a tree structure. When the root node is <code>cancel()</code> or terminated due to timeout, all its derived nodes will also be terminated, and the data of the root node will be shared by all derived nodes.</p><figure><img src="`+n+`" alt="context structure" tabindex="0" loading="lazy"><figcaption>context structure</figcaption></figure><h3 id="creating-root-nodes" tabindex="-1"><a class="header-anchor" href="#creating-root-nodes"><span>Creating Root Nodes</span></a></h3><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code>ctx <span class="token operator">:=</span> context<span class="token punctuation">.</span><span class="token function">Background</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">// Create a blank context</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="creating-derived-nodes" tabindex="-1"><a class="header-anchor" href="#creating-derived-nodes"><span>Creating Derived Nodes</span></a></h3><p>Use <code>context.WithXXX()</code> to create derived <code>context</code></p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="withvalue" tabindex="-1"><a class="header-anchor" href="#withvalue"><span>WithValue()</span></a></h2><p><code>context.WithValue()</code> can be used to create derived nodes and add key-value data, while retaining all data of the parent context.</p><h2 id="withdeadline-withtimeout" tabindex="-1"><a class="header-anchor" href="#withdeadline-withtimeout"><span>WithDeadline() WithTimeout()</span></a></h2><p><code>context.WithDeadline()</code> and <code>context.WithTimeout()</code> can be used to create a <code>context</code> with timeout control.</p><div class="hint-container warning"><p class="hint-container-title">Warning</p><p><code>WithTimeout(1*time.Second)</code> is equivalent to <code>WithDeadline(time.Now().Add(1*time.Second))</code></p></div><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="withcancel" tabindex="-1"><a class="header-anchor" href="#withcancel"><span>WithCancel()</span></a></h2><p>Using <code>WithCancel()</code> can create a manually terminated <code>context</code>. Executing <code>cancel()</code> can manually terminate it.</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
