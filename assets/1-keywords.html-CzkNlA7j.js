import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,b as e}from"./app-YBhseNzF.js";const t={},o=e(`<h2 id="keywords" tabindex="-1"><a class="header-anchor" href="#keywords"><span>Keywords</span></a></h2><p>Golang has 25 reserved keywords that cannot be used as program identifiers.</p><table><thead><tr><th>Type</th><th>Keywords</th><th>Introduction</th></tr></thead><tbody><tr><td>Declaration</td><td><code>const</code> <code>func</code> <code>import</code> <code>package</code> <code>type</code> <code>var</code></td><td>These keywords are used to declare various elements in the code.</td></tr><tr><td>Composite Types</td><td><code>chan</code> <code>interface</code> <code>map</code> <code>struct</code></td><td>These keywords are used to declare some special compound types.</td></tr><tr><td>Control Flow</td><td><code>break</code> <code>case</code> <code>continue</code> <code>default</code> <code>else</code> <code>fallthrough</code> <code>for</code> <code>goto</code> <code>if</code> <code>range</code> <code>return</code> <code>select</code> <code>switch</code></td><td>These keywords are used to control the flow of program execution.</td></tr><tr><td>Function Modifiers</td><td><code>defer</code> <code>go</code></td><td>Used to modify special functions.</td></tr></tbody></table><h2 id="declaration-types" tabindex="-1"><a class="header-anchor" href="#declaration-types"><span>Declaration Types</span></a></h2><h3 id="const" tabindex="-1"><a class="header-anchor" href="#const"><span><strong>const</strong></span></a></h3><p><code>const</code> is used to declare constants, which once declared cannot be changed, and must specify an initial value when declaring a constant.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">const</span> identifier T <span class="token operator">=</span> value  <span class="token comment">// T is the data type, which can be omitted, and the compiler will infer it.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="func" tabindex="-1"><a class="header-anchor" href="#func"><span><strong>func</strong></span></a></h3><p><code>func</code> is used to declare functions, supports multiple return values, and does not support default parameters.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// p is the parameter, T is the type</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="import" tabindex="-1"><a class="header-anchor" href="#import"><span><strong>import</strong></span></a></h3><p><code>import</code> is used to import packages to use their public identifiers.</p><p><code>import</code> supports single-line and multi-line imports.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">import</span> <span class="token string">&quot;flag&quot;</span> <span class="token comment">// single import</span>

<span class="token keyword">import</span> <span class="token punctuation">(</span>
    <span class="token string">&quot;flag&quot;</span>
    <span class="token string">&quot;fmt&quot;</span>
<span class="token punctuation">)</span> <span class="token comment">// multiple imports</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><p>We can also use <code>.</code>, <code>_</code>, and aliases to modify imported packages.</p><table><thead><tr><th>Import Command</th><th>Usage</th><th>Explanation</th></tr></thead><tbody><tr><td><code>import &quot;lib/math&quot;</code></td><td>math.Sin</td><td>Normal import requires the package name</td></tr><tr><td><code>import m &quot;lib/math&quot;</code></td><td>m.Sin</td><td>Aliases can be set during import</td></tr><tr><td><code>import . &quot;lib/math&quot;</code></td><td>Sin</td><td>Using <code>.</code> allows direct use of functions without the package name</td></tr></tbody></table><p>We can also use <code>_</code> to modify imported packages, which will only execute the package&#39;s initialization function <code>init()</code>.</p><h3 id="package" tabindex="-1"><a class="header-anchor" href="#package"><span><strong>package</strong></span></a></h3><p><code>package</code> is used to define the package name.</p><h4 id="type" tabindex="-1"><a class="header-anchor" href="#type"><span><strong>type</strong></span></a></h4><p><code>type</code> is used to define variable types.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// Define an interface</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="var" tabindex="-1"><a class="header-anchor" href="#var"><span><strong>var</strong></span></a></h3><p><code>var</code> is used to declare public or private variables.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">var</span> Name T  <span class="token comment">// public variable</span>
...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h2 id="composite-types" tabindex="-1"><a class="header-anchor" href="#composite-types"><span>Composite Types</span></a></h2><h3 id="chan" tabindex="-1"><a class="header-anchor" href="#chan"><span><strong>chan</strong></span></a></h3><p><code>chan</code> (Channel) is used to declare channels.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// Channel for sending and receiving data of type T</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="interface" tabindex="-1"><a class="header-anchor" href="#interface"><span><strong>interface</strong></span></a></h3><p><code>interface</code> is used to declare interfaces.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">type</span> File <span class="token keyword">interface</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="map" tabindex="-1"><a class="header-anchor" href="#map"><span><strong>map</strong></span></a></h3><p><code>map</code> is used to declare collections, consisting of unordered key-value pairs, with an underlying <code>hash map</code>. Although <code>map</code> will automatically expand, it is recommended to configure the capacity at initialization.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code>m <span class="token operator">:=</span> <span class="token function">make</span><span class="token punctuation">(</span><span class="token keyword">map</span><span class="token punctuation">[</span><span class="token builtin">string</span><span class="token punctuation">]</span><span class="token builtin">string</span><span class="token punctuation">)</span>  <span class="token comment">// empty map</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="struct" tabindex="-1"><a class="header-anchor" href="#struct"><span><strong>struct</strong></span></a></h3><p><code>struct</code> is used to declare structures.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">type</span> Person <span class="token keyword">struct</span> <span class="token punctuation">{</span>
    Name <span class="token builtin">string</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><p>Here is the translation into English:</p><h2 id="control-flow" tabindex="-1"><a class="header-anchor" href="#control-flow"><span>Control Flow</span></a></h2><h3 id="if-else" tabindex="-1"><a class="header-anchor" href="#if-else"><span><strong>if else</strong></span></a></h3><p><code>if</code> <code>else</code> is used for conditional judgments and can be nested.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">if</span> a <span class="token operator">&gt;</span> <span class="token number">0</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="switch-fallthrough" tabindex="-1"><a class="header-anchor" href="#switch-fallthrough"><span><strong>switch fallthrough</strong></span></a></h3><p><code>switch</code> is used to perform different actions based on different conditions. By default, each <code>case</code> comes with a <code>break</code>, and after executing one <code>case</code>, it will automatically exit. If you want to continue executing the following statements, you need to use <code>fallthrough</code>.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code>a <span class="token operator">:=</span> <span class="token string">&quot;2&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Using <code>fallthrough</code>, you can directly execute the action of the next <code>case</code> after completing the corresponding <code>case</code>.</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="for-break-continue-range" tabindex="-1"><a class="header-anchor" href="#for-break-continue-range"><span><strong>for break continue range</strong></span></a></h3><p><code>for</code> is used to loop actions, using <code>break</code> to interrupt the current <code>for</code> loop, and <code>continue</code> to skip the remaining statements of the current loop and continue with the next round.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// Single condition</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="goto" tabindex="-1"><a class="header-anchor" href="#goto"><span><strong>goto</strong></span></a></h3><p><code>goto</code> can jump to a specified location to continue executing actions.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="select" tabindex="-1"><a class="header-anchor" href="#select"><span><strong>select</strong></span></a></h3><p><code>select</code> allows <code>goroutine</code> to wait for multiple communication operations. <code>select</code> will block until one <code>case</code> receives information. If multiple channels receive data at the same time, a random <code>case</code> will be executed.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h2 id="function-modifiers" tabindex="-1"><a class="header-anchor" href="#function-modifiers"><span>Function Modifiers</span></a></h2><h3 id="defer" tabindex="-1"><a class="header-anchor" href="#defer"><span><strong>defer</strong></span></a></h3><p><code>return</code> is used to terminate the execution of a function and return zero or more return values. <code>defer</code> is used to perform actions before the function&#39;s <code>return</code> or after it has finished executing.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Note:</p><ul><li>The execution order of <code>defer</code> is last-in-first-out.</li><li><code>defer</code> executing before return means you can use defer to get the final result of variables before return.</li></ul><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="go" tabindex="-1"><a class="header-anchor" href="#go"><span><strong>go</strong></span></a></h3><p><code>go</code> is used to create a coroutine (goroutine) and perform actions in the background of the program.</p><details class="hint-container details"><summary>Example</summary><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details>`,62),i=[o];function c(p,l){return s(),a("div",null,i)}const r=n(t,[["render",c],["__file","1-keywords.html.vue"]]),k=JSON.parse('{"path":"/en/guide/concepts/golang/1-keywords.html","title":"Keywords","lang":"en-US","frontmatter":{"order":1,"title":"Keywords","description":"Keywords Golang has 25 reserved keywords that cannot be used as program identifiers. Declaration Types const const is used to declare constants, which once declared cannot be ch...","head":[["link",{"rel":"alternate","hreflang":"zh-cn","href":"https://goguide.ryansu.tech/guide/concepts/golang/1-keywords.html"}],["meta",{"property":"og:url","content":"https://goguide.ryansu.tech/en/guide/concepts/golang/1-keywords.html"}],["meta",{"property":"og:site_name","content":"Go Guide"}],["meta",{"property":"og:title","content":"Keywords"}],["meta",{"property":"og:description","content":"Keywords Golang has 25 reserved keywords that cannot be used as program identifiers. Declaration Types const const is used to declare constants, which once declared cannot be ch..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:locale:alternate","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-28T05:09:46.000Z"}],["meta",{"property":"article:author","content":"Go Guide"}],["meta",{"property":"article:modified_time","content":"2024-01-28T05:09:46.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Keywords\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-01-28T05:09:46.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Go Guide\\",\\"url\\":\\"https://github.com/suyuan32\\"}]}"]]},"headers":[{"level":2,"title":"Keywords","slug":"keywords","link":"#keywords","children":[]},{"level":2,"title":"Declaration Types","slug":"declaration-types","link":"#declaration-types","children":[{"level":3,"title":"const","slug":"const","link":"#const","children":[]},{"level":3,"title":"func","slug":"func","link":"#func","children":[]},{"level":3,"title":"import","slug":"import","link":"#import","children":[]},{"level":3,"title":"package","slug":"package","link":"#package","children":[{"level":4,"title":"type","slug":"type","link":"#type","children":[]}]},{"level":3,"title":"var","slug":"var","link":"#var","children":[]}]},{"level":2,"title":"Composite Types","slug":"composite-types","link":"#composite-types","children":[{"level":3,"title":"chan","slug":"chan","link":"#chan","children":[]},{"level":3,"title":"interface","slug":"interface","link":"#interface","children":[]},{"level":3,"title":"map","slug":"map","link":"#map","children":[]},{"level":3,"title":"struct","slug":"struct","link":"#struct","children":[]}]},{"level":2,"title":"Control Flow","slug":"control-flow","link":"#control-flow","children":[{"level":3,"title":"if else","slug":"if-else","link":"#if-else","children":[]},{"level":3,"title":"switch fallthrough","slug":"switch-fallthrough","link":"#switch-fallthrough","children":[]},{"level":3,"title":"for break continue range","slug":"for-break-continue-range","link":"#for-break-continue-range","children":[]},{"level":3,"title":"goto","slug":"goto","link":"#goto","children":[]},{"level":3,"title":"select","slug":"select","link":"#select","children":[]}]},{"level":2,"title":"Function Modifiers","slug":"function-modifiers","link":"#function-modifiers","children":[{"level":3,"title":"defer","slug":"defer","link":"#defer","children":[]},{"level":3,"title":"go","slug":"go","link":"#go","children":[]}]}],"git":{"createdTime":1705244739000,"updatedTime":1706418586000,"contributors":[{"name":"Ryan Su","email":"yuansu.china.work@gmail.com","commits":2}]},"readingTime":{"minutes":4.03,"words":1208},"filePathRelative":"en/guide/concepts/golang/1-keywords.md","localizedDate":"January 14, 2024","autoDesc":true,"excerpt":"<h2>Keywords</h2>\\n<p>Golang has 25 reserved keywords that cannot be used as program identifiers.</p>\\n<table>\\n<thead>\\n<tr>\\n<th>Type</th>\\n<th>Keywords</th>\\n<th>Introduction</th>\\n</tr>\\n</thead>\\n<tbody>\\n<tr>\\n<td>Declaration</td>\\n<td><code>const</code>  <code>func</code> <code>import</code>  <code>package</code>  <code>type</code> <code>var</code></td>\\n<td>These keywords are used to declare various elements in the code.</td>\\n</tr>\\n<tr>\\n<td>Composite Types</td>\\n<td><code>chan</code> <code>interface</code> <code>map</code> <code>struct</code></td>\\n<td>These keywords are used to declare some special compound types.</td>\\n</tr>\\n<tr>\\n<td>Control Flow</td>\\n<td><code>break</code> <code>case</code> <code>continue</code> <code>default</code> <code>else</code> <code>fallthrough</code> <code>for</code> <code>goto</code> <code>if</code> <code>range</code> <code>return</code> <code>select</code> <code>switch</code></td>\\n<td>These keywords are used to control the flow of program execution.</td>\\n</tr>\\n<tr>\\n<td>Function Modifiers</td>\\n<td><code>defer</code> <code>go</code></td>\\n<td>Used to modify special functions.</td>\\n</tr>\\n</tbody>\\n</table>"}');export{r as comp,k as data};
