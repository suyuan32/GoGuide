...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="并发" tabindex="-1"><a class="header-anchor" href="#并发"><span>并发</span></a></h2><p>在并发操作下 Map 不是线程安全的，可以使用官方的 <code>sync.Map{}</code> 解决</p>`,19);function o(c,l){return s(),a("div",null,[i,t(` ::: tip 社区专属
[如何保证 Map 线程安全?]()
